...
CREATE TABLE `t_nativefile` (
  ...
  `tag_str` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Table structure for table `t_nativefile_source` */

DROP TABLE IF EXISTS `t_nativefile_source`;

CREATE TABLE `t_nativefile_source` (
...
/*Table structure for table `t_nfile_tag_relation` */

DROP TABLE IF EXISTS `t_nfile_tag_relation`;

CREATE TABLE `t_nfile_tag_relation` (
  `id` bigint(255) NOT NULL,
  `native_file_id` bigint(255) DEFAULT NULL,
